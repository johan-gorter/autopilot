...
Normally a programmer would write the code and GitHub copilot helps out. In this experiment we will use **GitHub copilot chat** to write the code we tell it to, essentially turning it into an autopilot 🤯.

## Approach

Compared to humans, AI's have more knowledge and an almost perfect short-term memory.
